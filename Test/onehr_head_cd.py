...
driver.save_screenshot("Screenshots/ssopage.png")
                        ...
                        if content.find("Health Care"):
                            ...
                            if content.find("As of:"):
                                ...
                                if content.find("Recognition"):
                                    ...
                                    driver.get("https://onehr.ge.com/psp/prtl/GE_US2_SITE/EMPL/s/WEBLIB_GE_UTIL.GE_FUNCLIB_FLD.FieldFormula.IScript_BuildNav_JQMega?LType=C&LName=GE_PAY_SUMMARY&PFldr=PORTAL_ROOT_OBJECT")
                                    time.sleep(5)
                                    driver.save_screenshot("Screenshots/payhistory.png")
                                    content = driver.page_source
                                    if content.find("Pay History"):
                                        print ("Pay History : Successful")
                                        driver.get("https://onehr.ge.com/psp/prtl/GE_US2_SITE/EMPL/s/WEBLIB_GE_UTIL.GE_FUNCLIB_FLD.FieldFormula.IScript_BuildNav_JQMega?nodeId=126&LType=C&LName=GE_EDUCATIONAL_LOAN_PROGRAM&PFldr=GE_ADDITIONAL_BENEFITS")
                                        time.sleep(5)
                                        driver.save_screenshot("Screenshots/education.png")
                                        content= driver.page_source
                                        if content.find("GE Educational Loan Program"):
                                            print ("MSG: GE Educational Loan Program Page Loaded Successfully ")
                                            driver.get("https://onehr.ge.com/psp/prtl/GE_US2_SITE/EMPL/s/WEBLIB_GE_UTIL.GE_FUNCLIB_FLD.FieldFormula.IScript_BuildNav_JQMega?LType=C&LName=GE_HEALTH_PLAN_SUMMARY&PFldr=GE_HEALTH_CARE")
                                            time.sleep(5)
                                            driver.save_screenshot("Screenshots/healthplan.png")
                                            content= driver.page_source
                                            if content.find("Benefits Summary"):
                                                ...
                                                content= driver.page_source
                                                if content.find("You have been logged out of this application. To completely log out of Single Sign On, please close your browser."):
